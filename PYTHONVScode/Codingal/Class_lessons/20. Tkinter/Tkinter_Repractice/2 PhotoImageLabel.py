...
# setting the icon
root.iconbitmap(r"Codingal\Class_lessons\20. Tkinter\Tkinter_Repractice\yticon.ico")
...
# method 2
image = Image.open(r"Codingal\Class_lessons\20. Tkinter\Tkinter_Repractice\ytD.png")
...
sourceLinkInput = Entry(enterLinkFrame,textvariable=sourceLink,border=10,relief="ridge",font=("comicsansms",20,"bold"))
